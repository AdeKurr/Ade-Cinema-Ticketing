...
public class SciFiDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sci_fi_detail);
        ...
        String cinemaName = Data.sci_fi[cinemaId].getName();
        TextView textView = (TextView) findViewById(R.id.cinema_text);
        textView.setText(cinemaName);
        //poster pelm
        int cinemaImage = Data.sci_fi[cinemaId].getImageResourceId();
        ...
        //pemainnye
        String cinemaCasts = Data.sci_fi[cinemaId].getCasts();
        TextView textView1 = (TextView) findViewById(R.id.casts);
        textView1.setText(cinemaCasts);
        //synopsis
        String cinemaSynopsis = Data.sci_fi[cinemaId].getSynopsis();
